...
public class QuesoMov : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        ObjectAnim.SetBool("QuesoMuere", false);        // Seteamos que el bool, que triggea la animación de muerte, empiece en false
    }
    ...
    public void AtaqueAzar()                            // agarra la variante mencionada y le da un valor al azar
    {
        ...
        {
            ObjectAnim.Play("Queso_Atacando");
            Atacando();
    ...
    public void Death()                                 // Método para que muera
    {
        ...
        ObjectAnim.SetBool("QuesoMuere", true);         // triggea la animación de muerte

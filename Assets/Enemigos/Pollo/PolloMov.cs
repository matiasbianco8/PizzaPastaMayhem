...
public class PolloMov : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        ObjectAnim.SetBool("PolloMuere", false);        // Seteamos que el bool, que triggea la animación de muerte, empiece en false
    }
    ...
    public void Death()                                 // Método para que muera
    {
        ...
        ObjectAnim.SetBool("PolloMuere", true);         // triggea la animación de muerte

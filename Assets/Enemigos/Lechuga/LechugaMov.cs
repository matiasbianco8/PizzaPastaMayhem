...
public class LechugaMov : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        ObjectAnim.SetBool("LechugaMuere", false);        // Seteamos que el bool, que triggea la animación de muerte, empiece en false
    }
    ...
    public void AtaqueAzar()                            // agarra la variante mencionada y le da un valor al azar
    {
        ...
        {
            ObjectAnim.Play("Lechuga_Ataque");
            Atacando();
    ...
    public void Death()                                 // Método para que muera
    {
        ...
        ObjectAnim.SetBool("LechugaMuere", true);         // triggea la animación de muerte
